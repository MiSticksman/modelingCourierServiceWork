...
```
P.S. Для зачета было достаточно построить нормальную архитектуру и реализовать CRUD Для сущностей.

P.P.S. на этом и остановимся -_-
